...
const firebaseConfig = {
  apiKey: process.env.FIREBASE_API_KEY || "AIzaSyBuOCnk8ODeL7ZsdE2im0zNcQoo1GhWFm4",
  authDomain: process.env.FIREBASE_AUTH_DOMAIN || "gen-lang-client-0871236748.firebaseapp.com",
  projectId: process.env.FIREBASE_PROJECT_ID || "gen-lang-client-0871236748",
  storageBucket: process.env.FIREBASE_STORAGE_BUCKET || "gen-lang-client-0871236748.firebasestorage.app",
  messagingSenderId: process.env.FIREBASE_MESSAGING_SENDER_ID || "5903308790",
  appId: process.env.FIREBASE_APP_ID || "1:5903308790:web:fa71654c0a0a56c14519d7"
};
