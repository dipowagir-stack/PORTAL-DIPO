...
import { Shield, Building, Server, Settings, Activity, FileText, Grid, CreditCard, AlertCircle, Eye, Globe, LayoutTemplate, LogOut } from 'lucide-react';
      ...
      <div className="bg-indigo-900 rounded-xl shadow-lg border border-indigo-800 p-6 flex flex-col xl:flex-row xl:items-center justify-between gap-4 text-white">
        <div className="flex justify-between items-start w-full xl:w-auto">
          ...
          <button 
            ...
            className="xl:hidden p-2 text-indigo-300 hover:text-red-400 hover:bg-indigo-800 rounded-lg transition-colors"
            title="Keluar"
          >
        ...
        <div className="flex items-center space-x-3 w-full xl:w-auto overflow-x-auto pb-2 xl:pb-0">
          ...
          <button 
            onClick={handleLogout}
            className="hidden xl:flex items-center px-4 py-2 bg-red-500 hover:bg-red-600 text-white rounded-md text-sm font-medium transition-colors whitespace-nowrap shadow-sm border border-red-600"
          >
